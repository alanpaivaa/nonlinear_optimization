...
from unconstrained_optimization.descent_methods import SteepestDescent, STEEPEST_DESCENT_NORM_EUCLIDEAN, STEEPEST_DESCENT_NORM_QUADRATIC
...
optimizer = SteepestDescent(f=f, line_search=line_search, p=p, norm=STEEPEST_DESCENT_NORM_QUADRATIC)
